...
$projects = @(
	...
	@{ Name = "PortableExtensions.Net40.sln";    ShouldBuild = $true; RestoreNuGetPackages = $true; },
	@{ Name = "PortableExtensions.Portable.sln"; ShouldBuild = $true; RestoreNuGetPackages = $true; }
)
