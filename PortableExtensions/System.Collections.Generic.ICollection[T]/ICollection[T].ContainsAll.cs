...
namespace PortableExtensions
{
    ...
    {
        /// <summary>
        ///     Checks if the collection contains all given values.
        /// </summary>
        ...
        /// <param name="collection">The collection which should get checked..</param>
        /// <param name="values">A list of values.</param>
        /// <returns>Returns true if the collection contains all given values, otherwise false.</returns>
        public static Boolean ContainsAll<T>( this ICollection<T> collection, params T[] values )
        {
