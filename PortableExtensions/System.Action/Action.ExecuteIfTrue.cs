...
namespace PortableExtensions
{
    ...
    public static partial class ActionEx
    {
        ...
        public static void ExecuteIfTrue(this Action trueAction, Action falseAction = null, params Boolean[] values)
        {
            if (values.All(x => x))
            {
        ...
        /// <param name="falseAction">The action to execute if any of the given values is false.</param>
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfTrue<T>(this Action<T> trueAction, T parameter, Action<T> falseAction = null,
        ...
        public static void ExecuteIfTrue<T1, T2, T3, T4>(this Action<T1, T2, T3, T4> trueAction, T1 parameter1,
            T2 parameter2,
            T3 parameter3, T4 parameter4, Action<T1, T2, T3, T4> falseAction = null, params Boolean[] values)
        {
            if (values.All(x => x))
            {
                trueAction.ThrowIfNull(() => trueAction);
