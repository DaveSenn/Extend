...
namespace PortableExtensions
{
    ...
    public static partial class ActionEx
    {
        ...
        public static void ExecuteIfAnyFalse(this Action falseAction, Action trueAction = null, params Boolean[] values)
        {
            if (values.Any(x => !x))
            {
        ...
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfAnyFalse<T>(this Action<T> falseAction, T parameter, Action<T> trueAction = null,
        ...
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfAnyFalse<T1, T2, T3, T4>(this Action<T1, T2, T3, T4> falseAction, T1 parameter1,
