...
namespace PortableExtensions
{
    ...
    public static partial class ActionEx
    {
        ...
        public static void ExecuteIfFalse(this Action falseAction, Action trueAction = null, params Boolean[] values)
        {
            if (values.NotAny(x => x))
            {
                falseAction.ThrowIfNull(() => trueAction);
                falseAction();
            }
        ...
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfFalse<T>(this Action<T> falseAction, T parameter, Action<T> trueAction = null,
        ...
        public static void ExecuteIfFalse<T1, T2>(this Action<T1, T2> falseAction, T1 parameter1, T2 parameter2,
            Action<T1, T2> trueAction = null, params Boolean[] values)
        {
            if (values.NotAny(x => x))
            {
                falseAction.ThrowIfNull(() => trueAction);
        ...
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfFalse<T1, T2, T3>(this Action<T1, T2, T3> falseAction, T1 parameter1, T2 parameter2,
            T3 parameter3, Action<T1, T2, T3> trueAction = null, params Boolean[] values)
        {
            if (values.NotAny(x => x))
            {
                falseAction.ThrowIfNull(() => trueAction);
        ...
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfFalse<T1, T2, T3, T4>(this Action<T1, T2, T3, T4> falseAction, T1 parameter1,
            T2 parameter2, T3 parameter3, T4 parameter4, Action<T1, T2, T3, T4> trueAction = null,
            params Boolean[] values)
        {
            if (values.NotAny(x => x))
            {
