...
namespace PortableExtensions
{
    ...
    public static partial class ActionEx
    {
        ...
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfAnyTrue<T>(this Action<T> trueAction, T parameter, Action<T> falseAction = null,
        ...
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfAnyTrue<T1, T2>(this Action<T1, T2> trueAction, T1 parameter1, T2 parameter2,
            Action<T1, T2> falseAction = null, params Boolean[] values)
        {
            if (values.Any(x => x))
            {
                trueAction.ThrowIfNull(() => trueAction);
        ...
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfAnyTrue<T1, T2, T3>(this Action<T1, T2, T3> trueAction, T1 parameter1, T2 parameter2,
            T3 parameter3, Action<T1, T2, T3> falseAction = null, params Boolean[] values)
        {
            if (values.Any(x => x))
            {
                trueAction.ThrowIfNull(() => trueAction);
        ...
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfAnyTrue<T1, T2, T3, T4>(this Action<T1, T2, T3, T4> trueAction, T1 parameter1,
            T2 parameter2, T3 parameter3, T4 parameter4, Action<T1, T2, T3, T4> falseAction = null,
            params Boolean[] values)
        {
            if (values.Any(x => x))
            {
        ...
        /// <param name="parameter">The parameter to pass to the action with gets executed.</param>
        /// <param name="values">The Boolean values to check.</param>
        public static void ExecuteIfAnyTrue<T>(this Action<T> trueAction, T parameter,
            params Boolean[] values)
        {
            if (!values.Any(x => x))
                return;
