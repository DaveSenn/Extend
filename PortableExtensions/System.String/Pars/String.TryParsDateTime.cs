...
namespace PortableExtensions
{
    ...
    {
        /// <summary>
        ///     Converts the specified string representation of a date and time to its <see cref="DateTime"/> equivalent and returns a value that
        ...
        ///     parameter is <value>null</value>, is an empty string (""),
        ///     or does not contain a valid string representation of a date and time. This parameter is passed uninitialized.
        /// </param>
        /// <returns><value>true</value> if the s parameter was converted successfully; otherwise, <value>false</value>.</returns>
        ...
        ///  specified culture-specific format information and formatting style, and returns a value that indicates whether the conversion succeeded.
        /// </summary>
        ...
        /// <param name="dateTimeStyle">A bitwise combination of enumeration values that defines how to interpret the parsed date in relation to the current time zone or the current date. 
