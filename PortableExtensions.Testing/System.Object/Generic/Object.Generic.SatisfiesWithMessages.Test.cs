...
namespace PortableExtensions.Testing
{
    ...
    public partial class ObjectExTest
    {
        ...
        public void SatisfiesWithMessagesTestCase ()
        {
            ...
            var actual = "1234".SatisfiesWithMessages( specification ).ToList();
        ...
        public void SatisfiesWithMessagesTestCase1 ()
        {
            ...
            var actual = "234".SatisfiesWithMessages( specification ).ToList();
        ...
        public void SatisfiesWithMessagesTestCasenullCheck ()
        {
            ...
            "1234".SatisfiesWithMessages( specification ).ToList();
        }
    }
}