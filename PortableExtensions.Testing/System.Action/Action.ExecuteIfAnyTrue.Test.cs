...
namespace PortableExtensions.Testing
{
    ...
    public partial class ActionExTest
    {
        ...
        {
            ActionEx.ExecuteIfAnyTrue(null, null, false, true);
        }
        ...
        {
            ActionEx.ExecuteIfAnyTrue(null, RandomValueEx.GetRandomString(), null, false, true);
        }
        ...
        {
            ActionEx.ExecuteIfAnyTrue(null, RandomValueEx.GetRandomString(), RandomValueEx.GetRandomString(), null,
                false, true);
        }
        ...
        {
            ActionEx.ExecuteIfAnyTrue(null, RandomValueEx.GetRandomString(), RandomValueEx.GetRandomString(),
                RandomValueEx.GetRandomString(), null,
                false, true);
        }
        ...
        {
            ActionEx.ExecuteIfAnyTrue(null, RandomValueEx.GetRandomString(), RandomValueEx.GetRandomString(),
                RandomValueEx.GetRandomString(), RandomValueEx.GetRandomString(), null,
                false, true);
        }
        ...
        {
            Action action = null;
            action.ExecuteIfAnyTrue(false, true);
        }
        ...
        {
            Action<String> action = null;
            action.ExecuteIfAnyTrue(RandomValueEx.GetRandomString(), false, true);
        }
        ...
        {
            Action<String, String> action = null;
            action.ExecuteIfAnyTrue(RandomValueEx.GetRandomString(), RandomValueEx.GetRandomString(), false, true);
        }
        ...
        {
            Action<String, String, String> action = null;
            action.ExecuteIfAnyTrue(RandomValueEx.GetRandomString(), RandomValueEx.GetRandomString(), RandomValueEx.GetRandomString(), false, true);
        }
        ...
        {
            Action<String, String, String, String> action = null;
            action.ExecuteIfAnyTrue(RandomValueEx.GetRandomString(), RandomValueEx.GetRandomString(), RandomValueEx.GetRandomString(), RandomValueEx.GetRandomString(), false, true);
        }
    }
}
