...
namespace PortableExtensions.Testing
{
    ...
    public partial class ActionExTest
    {
        ...
        public void SafeExecuteTestCase5_1()
        {
            var actual =
                ActionEx
                    .SafeExecute(() => { }, typeof (ArgumentNullException),
                        typeof (ArgumentOutOfRangeException), typeof (InvalidCastException),
                        typeof (InvalidOperationException), typeof (ApplicationException));
            Assert.IsTrue(actual);

            actual =
                ActionEx
                    .SafeExecute(() => { throw new ArgumentNullException(); }, typeof (ArgumentNullException),
                        typeof (ArgumentOutOfRangeException), typeof (InvalidCastException),
                        typeof (InvalidOperationException), typeof (ApplicationException));
            Assert.IsFalse(actual);
            ...
            actual =
                ActionEx
                    .SafeExecute(() => { throw new ArgumentOutOfRangeException(); }, typeof (ArgumentNullException),
                        typeof (ArgumentOutOfRangeException), typeof (InvalidCastException),
                        typeof (InvalidOperationException), typeof (ApplicationException));
            Assert.IsFalse(actual);
            ...
            actual =
                ActionEx
                    .SafeExecute(() => { throw new InvalidCastException(); }, typeof (ArgumentNullException),
                        typeof (ArgumentOutOfRangeException), typeof (InvalidCastException),
                        typeof (InvalidOperationException), typeof (ApplicationException));
            Assert.IsFalse(actual);
            ...
            actual = ActionEx.SafeExecute(() => { throw new InvalidOperationException(); },
                ...
                typeof (ArgumentOutOfRangeException), typeof (InvalidCastException), typeof (InvalidOperationException),
                typeof (ApplicationException));
            Assert.IsFalse(actual);

            actual = ActionEx.SafeExecute(() => { throw new ApplicationException(); }, typeof (ArgumentNullException),
                typeof (ArgumentOutOfRangeException), typeof (InvalidCastException), typeof (InvalidOperationException),
                typeof (ApplicationException));
            Assert.IsFalse(actual);
        }
        ...
        {
            ActionEx.SafeExecute(() => { throw new OutOfMemoryException(); }, typeof (ArgumentNullException),
                typeof (ArgumentOutOfRangeException), typeof (InvalidCastException), typeof (InvalidOperationException),
                typeof (ApplicationException));
        }
