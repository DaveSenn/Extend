...
namespace PortableExtensions.Testing
{
    ...
    public partial class StringExTest
    {
        ...
        public void TryParsInt64TestCase()
        {
            ...
            var actual = expected.ToString( CultureInfo.InvariantCulture ).TryParsInt64( out result );
        ...
        public void TryParsInt64TestCase1()
        {
            ...
            var expected = (Int64) RandomValueEx.GetRandomInt32();
            var result = (Int64) RandomValueEx.GetRandomInt32();
            var actual = expected.ToString( culture ).TryParsInt64( NumberStyles.Any, culture, out result );
