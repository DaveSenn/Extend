...
namespace PortableExtensions.Testing
{
    ...
    public partial class StringExTest
    {
        ...
        public void TryParsByteTestCase ()
        {
            var expected = (byte) 1;
            var result = (byte) 3;
            var actual = expected.ToString( CultureInfo.InvariantCulture ).TryParsByte( out result );
        ...
        public void TryParsByteTestCase1 ()
        {
            ...
            var expected = (byte) 1;
            var result = (byte) 3;
            var actual = expected.ToString( culture ).TryParsByte( NumberStyles.Any, culture, out result );
