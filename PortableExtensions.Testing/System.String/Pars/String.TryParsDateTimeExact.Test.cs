...
namespace PortableExtensions.Testing
{
    ...
    public partial class StringExTest
    {
        ...
        public void TryParsDateTimeExactTestCase()
        {
            ...
            DateTime actual;
            var result = dateString.TryParsDateTimeExact("M/dd/yyyy hh:mm", new CultureInfo("en-US"), DateTimeStyles.None, out actual);
        ...
        public void TryParsDateTimeExactTestCase1()
        {
            ...
            DateTime actual;
            var result = dateString.TryParsDateTimeExact("Mm/dd/yyyy hh:mm", new CultureInfo("en-US"), DateTimeStyles.None, out actual);
        ...
        public void TryParsDateTimeExactTestCase2()
        {
            ...
            DateTime actual;
            var result = dateString.TryParsDateTimeExact(new [] { "MM/dd/yyyy hh:mm", "M/dd/yyyy hh:mm" }, new CultureInfo("en-US"), DateTimeStyles.None, out actual);
        ...
        public void TryParsDateTimeExactTestCase3()
        {
            ...
            DateTime actual;
            var result = dateString.TryParsDateTimeExact(new[] { "MM/dd/yyyy hh:mm", "MM/dd/yyyy hh:mm" }, new CultureInfo("en-US"), DateTimeStyles.None, out actual);
