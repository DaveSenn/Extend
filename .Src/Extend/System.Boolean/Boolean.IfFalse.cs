...
namespace Extend
{
    ...
    public static partial class BooleanEx
    {
        ...
        /// </summary>
        /// <exception cref="ArgumentNullException">Action can not be null, if the value is false.</exception>
        ...
        public static Boolean IfFalse( this Boolean value, Action action, Action alternativeAction = null )
        {
            if ( !value )
            {
